"""
Diffuse growth model of a leaf
==============================

In this example we will model diffuse growth of a leaf.

Diffuse growth is characterised by a homogeneous development of the leaf.

For this, we use an implicit module of order 1 with contant growth constants.
some linear law.
...
###############################################################################
# Define and plot the constant model of the growth constants.
#
...
model = imodal.Models.RegistrationModel([deformable_shape_source], [global_translation, small_scale_translation, growth], [imodal.Attachment.VarifoldAttachment(2, [20., 60.])], lam=100.)
