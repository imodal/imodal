"""
Acropetal Leaf Growth Model Using LDDMM and Dots Data
====================================================
...
###############################################################################
# Create the deformation model which only consist of one local translation module for LDDMM deformations.
#
...
lddmm_controls = [control[2] for control in intermediates['controls']]
...
controls = [[torch.tensor([]), torch.tensor([]), torch.tensor([]), lddmm_control] for lddmm_control in lddmm_controls]

# Reshoot.
intermediates_lddmm = {}
with torch.autograd.no_grad():
    imodal.HamiltonianDynamic.shoot(imodal.HamiltonianDynamic.Hamiltonian([silent_shape, silent_dots, deformation_grid, lddmm]), shoot_solver, shoot_it, controls=controls, intermediates=intermediates_lddmm)
