...
import StructuredFields.StructuredFields_p
from DeformationModules.DeformationModules import DeformationModule
...
from src import kernels as ker, functions_eta as fun_eta, pairing_structures as pair, field_structures as fields
...
class ElasticOrder1(DeformationModule):
    ...
    def __init__(self, sigma, N_pts, dim, coeff, C, nu):
        ...
        self.dimR = 3
        self.coeff = coeff
        self.GD = GeometricalDescriptors.GD_xR.GD_xR(N_pts, dim, C)
    ...
    def field_generator_curr(self):
        ...
        v = StructuredFields.StructuredFields_p.StructuredField_p(self.sig, self.dim)
