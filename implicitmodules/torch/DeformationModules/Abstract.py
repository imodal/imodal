...
class DeformationModule:
    ...
    def __call__(self, points, k=0):
        ...
        ----------
        points : torch.Tensor
            A :math:'[N, dim]' dimensioned tensor representing the points at which the generated vector field will be computed.
        k : int, default=0
        ...
        -------
        torch.Tensor
            A tensor representing the values of the k'th derivative of the generated vector field at positions given by *points*. For :math:'k=0', the output tensor is of shape :math:'[N, dim]'. For :math:'k=1', the output tensor is of shape :math:'[N, dim, dim], and so on for subsequent orders.
        """
        raise NotImplementedError

    def cost(self):
        """Compute the cost of the deformation given by the module.
