...
class ManifoldTensorContainer:
    ...
    def clone(self):
        ...
        **requires_grad** is then set to the same value as the current manifold tensor.
        Returns
        -------
        ManifoldTensorContainer
            The cloned manifold tensor.
        """
        out = ManifoldTensorContainer(self.__shapes)
...
class Manifold(BaseManifold):
    ...
    def __init__(self, shapes, nb_pts, gd, tan, cotan):
        ...
        self.__gd = ManifoldTensorContainer(self.shape_gd)
        self.__tan = ManifoldTensorContainer(self.shape_gd)
        self.__cotan = ManifoldTensorContainer(self.shape_gd)
