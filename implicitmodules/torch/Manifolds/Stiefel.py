...
from implicitmodules.torch.structuredfield import StructuredField_0, StructuredField_m, CompoundStructuredField
...
class Stiefel(Manifold):
    ...
    def inner_prod_field(self, field):
        ...
        return torch.dot(self.cotan[0].view(-1), man.tan[0].view(-1)) + torch.einsum('nij, nij->',
                                                                                     self.cotan[1].view(-1, self.__dim,
                                                                                                        self.__dim),
                                                                                     man.tan[1].view(-1, self.__dim,
                                                                                                     self.__dim))
