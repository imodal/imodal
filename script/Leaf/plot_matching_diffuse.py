...
To see another type of growth: :ref:`basipetal <sphx_glr__auto_examples_Leaf_plot_matching_basi.py>` or  :ref:`acropetal <sphx_glr__auto_examples_Leaf_plot_matching_acro.py>`
"""
...
# Source
with open('./data/diffuse.pkl', 'rb') as f:
